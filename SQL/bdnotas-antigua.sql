...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-06-2019 a las 19:37:01
...
(1, 'c# mvc', 'cohorte 1', 'mvc', '12 semanas', 'SANTA ANA', 1, 1, '2019-06-01', '2019-06-20'),
(2, 'xamarin', 'cohorte 2', 'xamarin', '12 semanas', 'SANTA ANA', 1, 1, '2019-06-01', '2019-07-03');
...
(1, 'somebody', 'whatever', '1998-06-16', 'MASCULINO', '21234578-9', '2547-845678-879-9', 'programacion', 'ADMINISTRADOR', '12345', 1);
...
(1, 'matematica', 'matematica', '12 horas', 1, 25, 25, 25, 25, 0, 0, 1),
(2, 'logica', 'logica', '12 horas', 1, 30, 30, 40, 0, 0, 0, 1),
(3, 'C#', 'C', '24 horas', 2, 25, 25, 50, 0, 0, 0, 1),
(4, 'certificacion C#', 'certificacion', '4 horas', 3, 100, 0, 0, 0, 0, 0, 1);
...
(1, 'sutan', 'sutan', '1995-02-12', 'MASCULINO', '02478959-9', '4578-789459-789-9', '3456789', 'en algun lugar de santa ana', '2345-6789', 'jp@jp.com', '12345', 1);
...
--
ALTER TABLE `tipo_modulo`
  MODIFY `id_tipo_modulo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
