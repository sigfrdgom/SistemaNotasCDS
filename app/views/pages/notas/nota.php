        ...
        <div class="row">
            ...
            <div class="card card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover display align-content-center">
                        <thead>
                            <tr>
                                <th>Participante</th>
                                <th>ModulosCurso</th>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="prt" method="POST" action="<?php echo RUTA_URL ?>/porcentajeCurso/create" data-parsley-validate novalidate>
                            ...
                            <input type="text" name="nnotas" placeholder="Escribe una observación para la matricula" class="form-control " pattern='[a-zA-zÑñÁÉÍÓÚáéíóúü,. ]{1,128}'>

                            <label for="nfinal" class="mrg-spr-ex">Nota final:</label>
                            <input type="number" name="nfinal" placeholder="Escribe el porcentaje. Ej. 25.0" class="form-control " min="0.0" max="10.0" step="0.1" required>

                            <label for="nobservacion" class="mrg-spr-ex">Observación de matricula:</label>
                            <input type="text" name="nobservacion" placeholder="Escribe una observación para la matricula" class="form-control " pattern='[a-zA-zÑñÁÉÍÓÚáéíóúü ]{1,128}'>
