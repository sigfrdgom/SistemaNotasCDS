            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
                        ...
                        <a href="<?php echo constant('RUTA_URL') ?>/reporte/dsmpParticipanteCohorte/<?php echo base64_encode($datos['curso'][0]->cohorte)?>">
                            <!-- <a href="<?php echo constant('RUTA_URL') ?>/reporte/dsmpParticipanteNivel/<?php echo base64_encode($datos['curso'][0]->cohorte)?>"> -->
                            
                                <i class="fas fa-arrow-circle-left color-primary"></i>
                            </a><?php echo $datos['titulo'] ?> &nbsp;</h1>
