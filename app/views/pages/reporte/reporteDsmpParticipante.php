            ...
            <table class="table table-md table-hover table-borderless">
                <thead class="thead bg-info-50">
                    <tr>
                        ...
                        <th rowspan="6" class="align-middle border border-dark">ACTIVIDADES</th>

                        <!-- <th class="align-middle border border-dark">ACTIVIDAD 1</th>
                        <th class="align-middle border border-dark">ACTIVIDAD 2</th>
                        <th class="align-middle border border-dark">ACTIVIDAD 3</th>
                        <th class="align-middle border border-dark">ACTIVIDAD 4</th>
                        <th class="align-middle border border-dark">ACTIVIDAD 5</th>
                        <th class="align-middle border border-dark">ACTIVIDAD 6</th> -->
                        <th class="align-middle border border-dark">PROMEDIO</th>
                    </tr>
                    <tr>
                        <?php
